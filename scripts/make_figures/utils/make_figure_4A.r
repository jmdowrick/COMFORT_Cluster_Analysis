load(paste0(config$data_results, "Fig_4A_integrated_diagnosis_breakdown.rData"))
...
p <- ggplot(comb) +
  ...
  scale_x_discrete()
p
ggsave(filename=paste0(config$figures, "Fig_4A_integrated_cluster_diagnoses.svg"), 
       width = 7, 
       height = 4, 
       units = "in")
